...
searchButton.addEventListener('click', event => {
    ...
    if (searchCategory == "") return;
        ...
        if (searchCategory == "all") {
            ...
            database.orderByChild("requestCategory").equalTo(searchCategory).on("child_added", (data) => {
...
function displayCard(row,key) {
    ...
    card.addEventListener('click', () => {
        if(cardCategory.innerHTML=="donations")
        {
          location.href ="donations.html?id="+key;
        }
        else{
...
//         const    Button = document.querySelector('.close-modal-button'); //Button on the modal that closes the model upon click;
