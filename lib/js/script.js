...
const requestCategory = document.getElementById("request-category-modal");
const requestImage = document.getElementById("request-image");
const requestPrice = document.getElementById("desired-price");
const requestName = document.getElementById("request-name");c
...
// database.on("child_added", updateDB);
function updateDB(event){
   ...
   if (title != '' && description != '' && category != '') {
       ...
       alert("Please include a title, description, and category!")
   }
...
function onSignIn(googleUser) {
 ...
 console.log("WYAYIGNNNNNNWYIWADNNNNNNNNNNNNGONGWYIWIGNNNNNNNNNNNNNNNN");  
